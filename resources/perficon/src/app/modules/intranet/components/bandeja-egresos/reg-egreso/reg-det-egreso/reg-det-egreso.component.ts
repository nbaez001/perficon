...
@Component({
  ...
  templateUrl: './reg-det-egreso.component.html',
  styleUrls: ['./reg-det-egreso.component.scss']
})
export class RegDetEgresoComponent implements OnInit {
  tiposEgreso: Maestra[] = [];
  ...
  constructor(private fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<RegDetEgresoComponent>,
